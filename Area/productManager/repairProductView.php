    ...
    <div class="container bg-light" >
        <div id="AreaView" class="row">
            ...
            <div class="col-9" id='selectCP'>
                  <h1 align="center"> Sửa Thông Tin Sản Phẩm Sản Phẩm</h1>
                  <hr>  
                  <div class="listproduct">
                    <form action="./backend/repairProduct.php" class="was-validated" method='post' enctype="multipart/form-data">
                        <div class="mb-3 mt-3">
                            ...
                            <?php
                                        ...
                                        if($conn->query($sql))
                                        {
                                            echo("<input type='text' class='form-control' id='uname' placeholder='Enter Tên Sản Phẩm' name='uname' value='".$row['nameProduct']."' required>
                        ...
                        <div class="mb-3">
                            ...
                            <?php
                                        ...
                                        if($conn->query($sql))
                                        {
                                            echo("  <input type='text' class='form-control' id='pwd' placeholder='Giá Tiền' value='".$row['Price']."' name='pswd' required>
                                            ");
                                        }              
                        ...
                        <div class="mb-3">
                            ...
                            <input type="file" class="form-control"  placeholder="ảnh" name="picture" required>
                            <div class="valid-feedback">Valid.</div>
                            <div class="invalid-feedback">Please fill out this field.</div>
                        </div>                
