    ...
    <div class="container bg-light">
        <div class="row">
            ...
            <div class="col-9 rightContent">
                ...
                $sql1='SELECT COUNT(*) FROM `product` WHERE `nameCategory`= "Mô Hình" ORDER BY ID DESC';
                ...
                if($countList['COUNT(*)']!=0)
                {
                    ...
                    if(isset($_GET['id']))
                    {
                        ...
                        <div class="selectPage" id="selectPage">
                            ...
                            <a href="/ProductForClient/SelectByCategory/figure.php?id='.($id-1).'">&laquo;</a>');
                            
                            if($tam-$check!=0)
                                {  
                                    if($check==0) {
                                        $tam1=0;$tam2=1;$tam3=2;
                                        echo(' <a href="/ProductForClient/SelectByCategory/figure.php?id='.$tam1.'" type="submit" name="id">'.$tam1.'</a>
                                        ');
                                        echo(' <a href="/ProductForClient/SelectByCategory/figure.php?id='.$tam2.'" type="submit" name="id">'.$tam2.'</a>
                                        '); 
                                        echo(' <a href="/ProductForClient/SelectByCategory/figure.php?id='.$tam3.'" type="submit" name="id">'.$tam3.'</a>
                                        ');
                                    }
                                    else{
                                        $page1=$check-1;
                                        $page2= $check+1;
                                        echo(' <a href="/ProductForClient/SelectByCategory/figure.php?id='.$page1.'" type="submit" name="id">'.$page1.'</a>
                                        ');
                                        echo(' <a href="/ProductForClient/SelectByCategory/figure.php?id='.$check.'" type="submit" name="id">'.$check.'</a>
                                        '); 
                                        echo(' <a href="/ProductForClient/SelectByCategory/figure.php?id='.$page2.'" type="submit" name="id">'.$page2.'</a>
                                        ');
                                    }
