    ...
    <div class="container bg-light">
        <div class="row">
            ...
            <div class="col-9 rightContent">
               ...
               <?php
                require '../../ConnectDB.php';
                $sql1='SELECT COUNT(*) FROM `product` WHERE `nameCategory`= "Quần Áo Cosplay" ORDER BY ID DESC';
                            ...
                            if($tam-$check!=0)
                                {  
                                    if($check==0) {
                                        ...
                                        echo(' <a href="/ProductForClient/SelectByCategory/clothes.php?id='.$tam1.'" type="submit" name="id">'.$tam1.'</a>
                                        ');
                                        echo(' <a href="/ProductForClient/SelectByCategory/clothes.php?id='.$tam2.'" type="submit" name="id">'.$tam2.'</a>
                                        '); 
                                        echo(' <a href="/ProductForClient/SelectByCategory/clothes.php?id='.$tam3.'" type="submit" name="id">'.$tam3.'</a>
                                        ');
                                    }
                                    else{
                                        $page1=$check-1;
                                        $page2= $check+1;
                                        echo(' <a href="/ProductForClient/SelectByCategory/clothes.php?id='.$page1.'" type="submit" name="id">'.$page1.'</a>
                                        ');
                                        echo(' <a href="/ProductForClient/SelectByCategory/clothes.php?id='.$check.'" type="submit" name="id">'.$check.'</a>
                                        '); 
                                        echo(' <a href="/ProductForClient/SelectByCategory/clothes.php?id='.$page2.'" type="submit" name="id">'.$page2.'</a>
                                        ');
                                    }
